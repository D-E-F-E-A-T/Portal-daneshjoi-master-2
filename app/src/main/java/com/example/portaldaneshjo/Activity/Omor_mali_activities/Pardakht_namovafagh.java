...
import com.example.portaldaneshjo.Adapter.ListViewAdapter_pardakhtnamovafagh;
...
public class Pardakht_namovafagh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar =  findViewById(R.id.toolbar_pardakht_error_id);
        list_namovafagh =  findViewById(R.id.list_pardakht_namovafagh_id);
